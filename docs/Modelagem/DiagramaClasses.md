...
Classes são elementos fundamentais na representação de entidades em sistemas. Elas são representadas visualmente como retângulos divididos em três partes: nome da classe na parte superior, atributos no meio (características dos objetos), e operações na parte inferior (ações que os objetos podem realizar). A Figura 1 exemplifica a notação usada para as classes.

<center>
Figura 1 - Notação de Classe 
<p align="center">
    <img src="assets/notacao_classe.png" alt="Notação de Classe"/></a></br>
</p>
<font>Fonte: <a href="https://creately.com/blog/pt/diagrama/tutorial-diagrama-de-classes/">Creately</a>, 2023</font>
</center>

### Relacionamentos

As classes estão interligadas de maneiras específicas em diagramas de classes. Esses relacionamentos incluem vários tipos, conforme a Tabela 1. Exemplos:

<center>
Tabela 1 - Notação de Relacionamentos
<p align="center">
    <img src="assets/notacao_classe_relacao.png" alt="Notação de Relacionamentos" width="800"/></a></br>
</p>
<font>Fonte: <a href="https://creately.com/blog/pt/diagrama/tutorial-diagrama-de-classes/">Creately</a>, 2023</font>
</center>
...
A versão 1.0 do Diagrama de Classes pode ser vista na Figura 2 e representa um esboço inicial das ideias dos integrantes acerca do escopo da aplicação.

<center>
Figura 2 - Diagrama de Classes Versão 1.0
<p align="center">
    <img src="assets/diagrama-de-classes.png" alt="Diagrama de Classes Versão 1.0" width="1000"/></a></br>
</p>
...
A versão 2.0 do diagrama apresentada na Figura 3, se justificou devido ao fato da ausência das semânticas entre as classes tornar o diagrama menos informativo e dificultar a compreensão das relações entre os objetos do sistema. Além disso, o título "Pagamento" não se adequava adequadamente à classe que representava, causando ambiguidade e confusão na interpretação do seu propósito. Portanto, a atualização do diagrama foi necessária para melhorar a clareza e a precisão da representação do sistema.

<center>
Figura 3 - Diagrama de Classes Versão 2.0
<p align="center">
    <img src="assets/diagrama-de-classes2.png" alt="Diagrama de Classes Versão 2.0" width="1000"/></a></br>
</p>
<font>Fonte: Autores, 2023</font>
</center>
