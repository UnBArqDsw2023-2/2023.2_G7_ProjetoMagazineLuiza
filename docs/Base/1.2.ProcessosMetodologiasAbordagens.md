...
O BPMN é uma ferramenta gráfica que é utilizada para expressar os processos de negócio em forma de diagramas. Seu principal objetivo é fornecer suporte ao gerenciamento de processo de negócio. Todas as especificações e detalhamentos do BPMN para o seguinte projeto podem ser encontrados [aqui](./1.Base.md/1.1.x.modelagem-bpmn.md).
