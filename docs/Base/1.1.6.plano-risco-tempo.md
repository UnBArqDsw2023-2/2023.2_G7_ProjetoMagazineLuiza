...
| **Externo**                  |                                                                               |            |               |                                                                            |                                                               |                                           |
| R07                          | Afastamento de integrantes por motivos de saúde.                              | Baixo      | Média         | Promoção de ambiente de trabalho agradável.                                | Ajuste na distribuição das tarefas do time.                   | <span style="color:#2e9500">0.05 </span>  |
