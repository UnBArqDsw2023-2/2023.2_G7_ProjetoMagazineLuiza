...
## Padrão de Projeto - Reutilização
...
| 1.0.6     | Adiona reutilização do singleton | [Douglas Alves](https://github.com/dougAlvs) e [Geovanna Maciel](https://github.com/manuziny) | [Matheus Henrique](https://github.com/mathonaut)  | 01/12/2023  | 
